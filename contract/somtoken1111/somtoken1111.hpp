...
namespace eosio {
    ...
    */
   CONTRACT somtoken1111 : public contract {
      public:
         ...
         using create_action = eosio::action_wrapper<"create"_n, &somtoken1111::create>;
         using issue_action = eosio::action_wrapper<"issue"_n, &somtoken1111::issue>;
         using retire_action = eosio::action_wrapper<"retire"_n, &somtoken1111::retire>;
         using transfer_action = eosio::action_wrapper<"transfer"_n, &somtoken1111::transfer>;
         using open_action = eosio::action_wrapper<"open"_n, &somtoken1111::open>;
         using close_action = eosio::action_wrapper<"close"_n, &somtoken1111::close>;
      private:
