...
<div class="modal__info--tutorial">
  ...
  first duel. Click on the card to remove it from the deck. You can click the arrows to switch between different deck slots,
  and the edit icon to change the deck name.
</div>
